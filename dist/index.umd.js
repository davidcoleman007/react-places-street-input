...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ReactPlacesStreetInput = __webpack_require__(1);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /*
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * Modified to support chrome auto-fill by David Coleman
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * 
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * original component:
	...
	var ReactPlacesStreetInput = function (_Component) {
	  _inherits(ReactPlacesStreetInput, _Component);
	
	  function ReactPlacesStreetInput(props) {
	    _classCallCheck(this, ReactPlacesStreetInput);
	
	    var _this = _possibleConstructorReturn(this, (ReactPlacesStreetInput.__proto__ || Object.getPrototypeOf(ReactPlacesStreetInput)).call(this, props));
	  ...
	  _createClass(ReactPlacesStreetInput, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      if (!window.google) {
	        throw new Error('Google Maps JavaScript API library must be loaded. See: https://github.com/davidcoleman007/react-places-street-input#load-google-library');
	      }
	
	      if (!window.google.maps.places) {
	        throw new Error('Google Maps Places library must be loaded. Please add `libraries=places` to the src URL. See: https://github.com/davidcoleman007/react-places-street-input#load-google-library');
	      }
	    ...
	    value: function getInputProps() {
	      ...
	      return _extends({}, defaultInputProps, this.props.inputProps, {
	        ...
	        onFocus: function onFocus(event) {
	          _this2.handleInputOnFocus(event);
	        },
	      ...
	      return _react2.default.createElement(
	        ...
	        autocompleteItems.length > 0 && _react2.default.createElement(
	          ...
	          this.props.googleLogo && _react2.default.createElement(
	            'div',
	            {
	              id: 'ReactPlacesStreetInput__google-logo',
	  ...
	  return ReactPlacesStreetInput;
	}(_react.Component);
	
	ReactPlacesStreetInput.propTypes = {
	...
	ReactPlacesStreetInput.defaultProps = {
